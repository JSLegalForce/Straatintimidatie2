...
'0.1':{t:'hero',a:'boa-armen',rows:['doel','certificaat']},
'0.2':{t:'split',a:'boa-uitleg',rev:1,rows:['lagen','toets']},
'0.3':{t:'info',v:'opzet'},
'0.4':{t:'onthoud',a:'boa-armen',icons:['route','lagen','toets']},
/* 2 Achtergrond en doel */
'1.0':{t:'lo',a:'boa-armen'},
'1.1':{t:'split',a:'wetboek',rows:['kalender']},
...
'1.14':{t:'split',a:'doelwit',rev:1,rows:['doel']},
'1.15':{t:'split',a:{icon:'wet',orbit:['schild','mensen','lamp']},rows:['wet','schild']},
'1.16':{t:'split',a:'boa-armen',rev:1,rows:['boa']},
'1.17':{t:'split',a:{icon:'schild',orbit:['mensen','locatie','wereld']},rows:['schild']},
'1.18':{t:'split',a:'scene-online',rev:1,rows:['persoon','online']},
'1.19':{t:'praktijk',a:'boa-uitleg',ic:'snelheid'},
'1.20':{t:'praktijk',a:'boa-armen',ic:'lijst'},
...
'2.2':{t:'wet'},
'2.3':{t:'bd',s:1,a:{icon:'locatie',orbit:['straat','bus','winkel']},rows:['locatie']},
...
'2.9':{t:'bd',s:2,a:'scene-een-ander',rev:1,rows:['mensen']},
'2.10':{t:'bd',s:3,a:{vis:'vormen'},rows:['ballon']},
'2.11':{t:'bd',s:3,a:{icon:'geluid',orbit:['uitlating','aanraking','gebaar']},rev:1,rows:['geluid']},
...
'3.2':{t:'split',a:'weegschaal',rev:1,rows:['ballon','context']},
'3.3':{t:'info',v:'vaten'},
'3.4':{t:'split',a:{vis:'context'},rows:['context']},
'3.5':{t:'split',a:{icon:'document',orbit:['duur','herhaling','locatie']},rev:1,rows:['document']},
'3.6':{t:'info',v:'vergelijk'},
'3.7':{t:'casus',a:{vis:'gedrag'},stack:1},
'3.8':{t:'casus',a:'scene-steeg-nacht-2'},
'3.9':{t:'praktijk',a:'boa-notitie'},
'3.10':{t:'praktijk',a:'weegschaal',ic:'oog'},
...
'5.2':{t:'split',a:{vis:'bestanddelen'},rev:1,rows:['lijst']},
'5.3':{t:'split',a:{vis:'pvvragen'},rows:['pv'],wide:1},
'5.4':{t:'bewijsmiddelen',a:'wetboek',icons:['oog','persoon','getuige','deskundige','document']},
'5.5':{t:'split',a:'boa-dossier',rows:['pv']},
'5.6':{t:'split',a:'pv-document',rev:1,rows:['pv']},
...
'5.14':{t:'split',a:{vis:'bushalte'},rev:1,rows:['licht'],wide:1},
...
'7.9':{t:'info',v:'beslishulp'},
'7.10':{t:'hero',a:'boa-armen',rows:['toets','boek'],eind:1}
};
...
'scene-online':'Openbaar bericht op sociale media','scene-et-openbare-ruimte':'Drukke Nederlandse winkelstraat overdag: een vrouw loopt ontspannen alleen over straat, met andere voetgangers, een fietser en een terras om haar heen','scene-et-bewijs':'Boa aan een bureau beoordeelt meerdere bewijsstukken; voor haar liggen foto\u2019s en documenten en naast haar staan ordners met meldingen, getuigenverklaringen en beelden','scene-et-pv-computer':'Boa werkt op kantoor achter een laptop haar waarnemingen uit; naast haar liggen ordners met processen-verbaal, incidenten en rapportages','scene-et-uitgaan2':'Druk uitgaansgebied in de avond: een vrouw loopt door langs cafés met uitgaanspubliek; op enige afstand achter haar roept een man haar iets na','scene-et-portiek':'Portiek in de avond: een man staat dicht bij een vrouw en houdt met zijn arm de doorgang bij de brievenbussen afgesloten; zij kijkt angstig weg','scene-et-rechter':'Rechter in toga bestudeert een dossier in de rechtszaal','scene-et-rechter-dossier':'Nederlandse rechter in toga beoordeelt een dossier met proces-verbaal','scene-et-wetboek-429ter':'Opengeslagen wetboek met artikel 429ter Sr: opmerkingen, gebaren, geluiden en aanrakingen; vreesaanjagend, vernederend, kwetsend of onterend','scene-et-online-chat':'Vrouw kijkt geschrokken naar haar telefoon; ernaast een openbare online chatgroep met 8.421 leden waarin meerdere deelnemers seksuele opmerkingen over haar plaatsen','scene-et-waarneming':'Boa noteert in de avond haar waarnemingen; op de achtergrond loopt een vrouw weg en staat een man met pet','pv-bushalte':'Bushalte overdag: een man met pet spreekt op enige afstand een vrouw aan; zij kijkt ongemakkelijk opzij','pv-bus':'Drukke stadsbus: dezelfde man staat dicht bij dezelfde vrouw, die zich vasthoudt aan een gele stang en ongemakkelijk opzij kijkt','gedrag-eenmalig':'Winkelstraat bij daglicht: een man maakt in het voorbijgaan een opmerking tegen een vrouw; zij kijkt ongemakkelijk opzij','gedrag-herhalen':'Parkeergarage in de avond: een man blijft achter een vrouw lopen en spreekt haar opnieuw aan; zij kijkt ongemakkelijk om','cmp-plein-dag':'Druk plein bij daglicht: een man loopt dicht achter een vrouw en kijkt glimlachend naar haar; zij kijkt ongemakkelijk opzij','cmp-station-avond':'Treinperron in de avond: dezelfde man loopt even dicht achter dezelfde vrouw en kijkt glimlachend naar haar; zij kijkt ongemakkelijk opzij','proces-boa':'Boa in uniform op straat','proces-pv':'Close-up van een proces-verbaal met aangevinkte punten','proces-ovj':'Officier van justitie met dossier bij het Openbaar Ministerie','proces-rechter':'Rechter in toga in de rechtszaal','scene-steeg-nacht-2':'Smal steegje in het donker: een man loopt achter een vrouw; zij kijkt alert om','scene-vernederend':'Plein bij daglicht: drie mannen kijken lachend naar een vrouw en één van hen wijst naar haar; zij kijkt ongemakkelijk om','scene-aanraking-schouder':'Marktplein bij daglicht: een man legt zijn hand op de schouder van een vrouw; zij kijkt ongemakkelijk om','scene-een-ander':'Winkelstraat bij daglicht: twee vrouwen lopen naast elkaar; een man loopt mee en spreekt hen allebei aan','scene-nafluiten':'Drukke winkelstraat bij daglicht: een man fluit op afstand één keer naar een vrouw die voor hem loopt; zij kijkt opzij','scene-samenleving':'Straat in de stad: een volwassen vrouw kijkt ongemakkelijk opzij; op de achtergrond staan twee mannen die naar haar kijken','wetboek':'Wetboek van Strafrecht, artikel 429ter',
...
const ART_FILE={'proces-boa':'../images/proces-boa.webp','proces-pv':'../images/proces-pv.webp','proces-ovj':'../images/proces-ovj.webp','proces-rechter':'../images/proces-rechter.webp','scene-steeg-nacht-2':'../images/steegje-donker-achter-vrouw.webp','scene-vernederend':'../images/vreesaanjagend-vernederend-plein.webp','scene-aanraking-schouder':'../images/aanraking-schouder-marktplein.webp','scene-een-ander':'../images/bestanddeel-een-ander-meerdere-personen.webp','scene-nafluiten':'../images/indringend-nafluiten-daglicht.webp','scene-samenleving':'scene-samenleving.webp','scene-plein-dag':'scene-plein-dag.webp','scene-steeg-nacht':'scene-steeg-nacht.webp','scene-winkelstraat':'scene-plein-dag.webp','scene-uitgaan':'../images/uitgaansgebied-opmerking-station.webp','cmp-plein-dag':'../images/context-plein-daglicht.webp','cmp-station-avond':'../images/context-station-avond.webp','gedrag-eenmalig':'../images/eenmalige_opmerking_licht.webp','gedrag-herhalen':'../images/volgen_en_herhalen_donker.webp','pv-bushalte':'../images/bushalte_opmerking_afstand.webp','pv-bus':'../images/bus_dichtbij_opmerking.webp','scene-et-waarneming':'../images/eindtoets_boa_waarneming.webp','scene-et-online-chat':'../images/eindtoets_openbare_online_chat.webp','scene-et-rechter':'../images/eindtoets_rechter_jurisprudentie.webp','scene-et-rechter-dossier':'../images/eindtoets_rechter_dossier_jurisprudentie.webp','scene-et-wetboek-429ter':'../images/eindtoets_wetboek_429ter_bestanddelen.webp','scene-et-portiek':'../images/eindtoets_praktijkcasus_portiek.webp','scene-et-uitgaan2':'../images/eindtoets_praktijkcasus_uitgaansgebied_v2.webp','scene-et-pv-computer':'../images/eindtoets_procesverbaal_boa_computer.webp','scene-et-bewijs':'../images/eindtoets_bewijs_artikel429ter.webp','scene-et-openbare-ruimte':'../images/eindtoets_openbare_ruimte_vrij_veilig.webp'};
...
const VIS={
  ...
  gedrag(){
    return '<div class="vis vis-cmp cmp-gedrag"><figure class="cmp">'+IMG('gedrag-eenmalig')+'<figcaption>'+di('zon')+'<span class="cg-t"><b>Eenmalige opmerking</b><small>maakt een opmerking en loopt verder</small></span></figcaption></figure><span class="cmp-ne" aria-hidden="true">≠</span><figure class="cmp cmp-n">'+IMG('gedrag-herhalen')+'<figcaption>'+di('maan')+'<span class="cg-t"><b>Volgen en herhalen</b><small>blijft haar benaderen en maakt meerdere opmerkingen</small></span></figcaption></figure></div>';
  },
  bushalte(){
    return '<div class="vis vis-cmp cmp-bus"><figure class="cmp">'+IMG('pv-bushalte').replace('<img ','<img style="object-position:78% 20%" ')+'<figcaption>'+di('zon')+'<span class="cg-t"><b>Bushalte</b><small>maakt een opmerking op afstand</small></span></figcaption></figure><span class="cmp-ne" aria-hidden="true">≠</span><figure class="cmp cmp-n">'+IMG('pv-bus').replace('<img ','<img style="object-position:50% 20%" ')+'<figcaption>'+di('bus')+'<span class="cg-t"><b>In de bus</b><small>staat dicht bij haar en maakt dezelfde opmerking</small></span></figcaption></figure></div>';
  },
  proces2(){
...
const FIG={
  ...
  vaten(){
    const f=[['duur','duur'],['herhaling','herhaling'],['afstand','afstand'],['locatie','plaats · tijdstip'],['hand','reactie op afwijzing'],['schild','kwetsbare positie']];
    return '<div class="fig fig-vaten"><div class="vt-row"><div class="vt-box vt-a">'+di('ballon')+'<b>Inhoud van de uiting</b><small>woorden · gebaren · aanrakingen</small></div>'
      +'<div class="vt-link"><span aria-hidden="true">⇅</span><em>communicerende vaten</em></div>'
      +'<div class="vt-box vt-b">'+di('context')+'<b>Context en omstandigheden (voorbeelden)</b><div class="vt-f">'+f.map(x=>'<span class="chip">'+di(x[0])+x[1]+'</span>').join('')+'</div></div></div>'
      +'<div class="vt-down" aria-hidden="true">↓</div><div class="vt-tot">'+di('wet')+'<div><b>Totaalbeeld</b><small>naar algemene maatstaven beoordeeld</small></div></div>'
      +'<p class="fig-note">'+di('lamp')+'<span>Geen enkele omstandigheid is op zichzelf beslissend; <br>het totaalbeeld bepaalt de beoordeling.</span></p></div>';
  },
  vergelijk(){
    return '<div class="fig fig-cmp"><div class="vis-cmp big"><figure class="cmp">'+IMG('cmp-plein-dag').replace('<img ','<img style="object-position:38% 12%" ')+'<figcaption><span class="cmp-h">'+di('zon')+'Plein · daglicht</span><span>druk, zichtbaar</span><strong class="ok">meestal geen delict</strong></figcaption></figure>'
      +'<span class="cmp-ne" aria-hidden="true">≠</span><figure class="cmp cmp-n">'+IMG('cmp-station-avond').replace('<img ','<img style="object-position:38% 12%" ')+'<figcaption><span class="cmp-h">'+di('maan')+'Station · avond</span><span>rustiger, minder zichtbare omgeving</span><strong class="warn">kan wél een delict zijn</strong></figcaption></figure></div>'
      +'<p class="fig-note">'+di('context')+'Dezelfde gedraging; de context bepaalt de uitkomst.</p></div>';
  },
  tijdlijn(){
  ...
  tikpv(){
    return '<div class="fig fig-tik"><div class="tk-row"><div class="tk tk-s">'+di('pv')+'<b>Tik-pv (verkort)</b><span>eenvoudige,</span><span>duidelijke zaak</span><div class="tk-lines"><i></i><i></i><i></i></div></div>'
      +'<span class="tk-vs" aria-hidden="true">·</span><div class="tk tk-l">'+di('dossier')+'<b>Uitgebreid pv</b><span>complexe of</span><span>betwiste zaak</span><div class="tk-lines"><i></i><i></i><i></i><i></i><i></i><i></i></div></div></div>'
      +'<div class="tk-both">'+di('vink')+'<div><b>Beide dekken álle bestanddelen.</b><span>Verkort betekent niet minder zorgvuldig.</span></div></div></div>';
  },
  beslishulp(){
...
function certificaat(pct){
  ...
  let nr=(ex&&ex.nr)?ex.nr:('JSLF-SI-'+jaar+'-'+Math.random().toString(36).slice(2,8).toUpperCase());
  if(ex){ex.nr=nr;save();}
...
T.hero=(P,spec,st)=>{
  ...
  box.appendChild(el('div','hero-art',boaHTML(spec.a,{sz:'hero'})+'<div class="float-chip fc1">'+di(spec.eind?'toets':'wet')+'<span>'+(spec.eind?'Klaar voor<br>de eindtoets':'Artikel 429ter Sr')+'</span></div>'));
  return box;
};
T.lo=(P,spec,st)=>{
...
T.casus=(P,spec,st)=>{
  const box=el('div','casus-page'+((spec.a&&spec.a.compare)||spec.stack?' stack':''));
  ...
  const nodes=mainParas(P);
  const body=el('div','casus-body');nodes.forEach(n=>body.appendChild(n));body.querySelectorAll('.irow').forEach(r=>r.insertAdjacentHTML('afterbegin',di('ballon')));card.appendChild(body);
