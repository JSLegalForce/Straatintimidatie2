...
'2.12':{t:'bd',s:3,a:{icon:'waarschuwing',orbit:['aanraking','wet','schild']},rows:['waarschuwing']},
...
'scene-online':'Openbaar bericht op sociale media','scene-een-ander':'Winkelstraat bij daglicht: twee vrouwen lopen naast elkaar; een man loopt mee en spreekt hen allebei aan','scene-nafluiten':'Drukke winkelstraat bij daglicht: een man fluit op afstand één keer naar een vrouw die voor hem loopt; zij kijkt opzij','scene-samenleving':'Straat in de stad: een volwassen vrouw kijkt ongemakkelijk opzij; op de achtergrond staan twee mannen die naar haar kijken','wetboek':'Wetboek van Strafrecht, artikel 429ter',
...
const ART_FILE={'scene-een-ander':'../images/bestanddeel-een-ander-meerdere-personen.webp','scene-nafluiten':'../images/indringend-nafluiten-daglicht.webp','scene-samenleving':'scene-samenleving.webp','scene-plein-dag':'scene-plein-dag.webp','scene-steeg-nacht':'scene-steeg-nacht.webp','scene-winkelstraat':'scene-plein-dag.webp'};
